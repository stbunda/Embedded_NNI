...
# ImageNet_path = '/deepstore/datasets/dmb/MachineLearning/ImageNet/ILSVRC/Data/CLS-LOC/'
#
#
# train_dataloader = torch.utils.data.DataLoader(ImageNet(ImageNet_path, split='train'),
#                                                batch_size=64,
#                                                shuffle=True)
#
# validation_dataloader = torch.utils.data.DataLoader(ImageNet(ImageNet_path, split='val'),
#                                                batch_size=64,
#                                                shuffle=True)
...
def evaluating_model(model: torch.nn.Module):
    ...
    return correct / len(cifar10_test)
